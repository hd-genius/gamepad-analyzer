...
describe("useJoystick", () => {
    ...
    ])("should return the correct value for the %s joystick's horizontal axis", (name, joystickId, expectedValue, ...axes) => {
    ...
    ])("should return the correct value for the %s joystick's vertical axis", (name, joystickId, expectedValue, ...axes) => {
        useGamepad.mockReturnValue({
            axes
        });
